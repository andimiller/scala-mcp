...
object McpClient:
  ...
  private def jsonRpcBody(method: String, params: Json): Body =
    Body.json(Json.obj("jsonrpc" -> "2.0".asJson, "id" -> nextId().asJson, "method" -> method.asJson, "params" -> params).noSpaces)
